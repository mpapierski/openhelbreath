...
SDL_Surface *Font::TextShaded(const std::string &Text, int R, int G, int B)
{
	...
	ShadowSurface = TTF_RenderUTF8_Solid(Game::GetInstance().Font, Text.c_str(), ShadowColor);
...
static char Space[] = {8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,6,8,7,8,8,9,10,9,7,8,8,8,8,8,8,8,
...
SDL_Surface *Font::SprText(const std::string &Text)
{
	...
	ReturnSurface = Surface::CreateSurface(
						Width,
						Game::GetInstance().Sprites[SPRID_SPRFONT].GetMaxFrameH(),
						128,
						128,
						128,
						255);
